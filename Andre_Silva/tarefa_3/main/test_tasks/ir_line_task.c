...
#include "wheel.h" //Pra eu usar o wheel_SetVel(Vel_rodaEsquerda, Vel_rodaDireita). Comentar se eu usar PID
#include "body_2wd.h" //Para usar o PID
#include "pid_task.h"

#include "wcet_gpio.h"//tarefa 3
...
//void app_main()
{
	...
	while (1) {
		WCET_INICIO(WCET_GPIO_IRLINE); //tarefa 3
		...
		WCET_FIM(WCET_GPIO_IRLINE); //tarefa 3
